...
export const GIT_COMMIT_SHORT: string = ${JSON.stringify(sha)};
export const GIT_COMMIT_MESSAGE: string = ${JSON.stringify(commitMsg)};
export const BUILD_TIME_ISO: string = ${JSON.stringify(builtAt)};
